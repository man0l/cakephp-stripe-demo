...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'firstname' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'lastname' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            ...
            'BY_EMAIL_PASSWORD' => ['type' => 'index', 'columns' => ['email', 'password'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created_at' => '2021-03-28 09:57:38',
            ],
        ];
        parent::init();
    }
